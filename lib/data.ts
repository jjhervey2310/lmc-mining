...
export const PROVIDERS_DATA = [
  ...
  },
  {
    id: 9,
    name: 'BlockOps Mining',
    website: 'https://blockopsmining.com',
    location: 'USA',
    power_sources: ['Grid'],
    cooling_type: 'Air',
    pricing_model: 'Variable',
    ...
    financing_rate_percent: 0,
    financing_term_months: 0,
    uptime_sla_percent: null,
    setup_fee_usd: 50,
    rating: 4.0,
    reviews_count: 0,
    affiliate_program: false,
    affiliate_commission_percent: 0,
    notes: 'Tiered pricing: $0.078 (10-25 miners), $0.075 (25-100), $0.073 (100-300), $0.07 (300+). Setup: $50/miner. Air-cooled only, Hydro planned 2026.',
  },
];
