...
export const metadata: Metadata = {
  title: { absolute: 'Terms of Service | LMC Mining Intelligence' },
  description: 'Terms of service for LMC Mining Intelligence. Read our terms governing use of our Bitcoin mining data, tools, and audit services.',
}
    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-sm text-gray-300 leading-relaxed">
        ...
        <section>
          ...
          <p>By accessing or using lmc-mining.vercel.app (the &quot;Site&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree, do not use the Site. These Terms are governed by the laws of the State of Colorado, USA.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-white mb-3">2. Description of Service</h2>
          <p>LMC Mining Intelligence provides independent Bitcoin mining data, profitability calculators, hardware comparisons, hosting provider reviews, and consulting services including deal audits. The Site is provided for informational and educational purposes.</p>
        </section>
        ...
        <section>
          ...
          <ul className="space-y-2 text-gray-400">
            ...
            <li>· We provide professional analysis based on information you supply. Inaccurate information you provide may affect analysis quality. LMC Mining is not liable for outcomes resulting from inaccurate inputs.</li>
        ...
        <section>
          ...
          <p>The Site contains links to third-party websites including hardware marketplaces, hosting providers, and exchanges. LMC Mining does not control and is not responsible for the content, privacy practices, or terms of any third-party site. Linking does not imply endorsement beyond our editorial assessment.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-white mb-3">9. Limitation of Liability</h2>
          <p>To the maximum extent permitted by law, LMC Mining Intelligence shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your use of the Site or services, including but not limited to losses from mining operations, hardware purchases, or hosting agreements made in reliance on our content.</p>
        </section>
        ...
        <section>
          ...
          <p>You agree to indemnify and hold harmless LMC Mining Intelligence, its founders, and affiliates from any claims, damages, or expenses (including attorney fees) arising from your use of the Site, your violation of these Terms, or your violation of any third-party rights.</p>
        </section>
